// server/config.ts
import ./../node_modules/@babel/core/lib/gensync-utils/./../node_modules/@babel/core/lib/gensync-utils/./../node_modules/@babel/core/lib/gensync-utils/./../node_modules/@babel/core/lib/gensync-utils/fs from "fs";
import ./../node_modules/canvg/node_modules/regenerator-runtime/./../node_modules/canvg/node_modules/regenerator-runtime/./../node_modules/canvg/node_modules/regenerator-runtime/./../node_modules/canvg/node_modules/regenerator-runtime/./../node_modules/canvg/node_modules/regenerator-runtime/./../node_modules/canvg/node_modules/regenerator-runtime/./../node_modules/canvg/node_modules/regenerator-runtime/./../node_modules/canvg/node_modules/regenerator-runtime/./../node_modules/canvg/node_modules/regenerator-runtime/./../node_modules/canvg/node_modules/regenerator-runtime/./../node_modules/canvg/node_modules/regenerator-runtime/path from "path";
import { fileURLToPath } from "./../node_modules/caniuse-lite/data/features/./../node_modules/caniuse-lite/data/features/./../node_modules/caniuse-lite/data/features/./../node_modules/caniuse-lite/data/features/url";
...
var FileStorage = class {
  ...
  async addSale(sale) {
    ...
    const paddedCount = String(saleCount).padStart(3, "0");
    const transactionId = `TRX-${formattedDate}-${paddedCount}`;
    const newSale = {
      ...sale,
      // Type cast to avoid TypeScript errors
      id: transactionId,
  ...
  async updateStats(updates) {
    try {
      ...
      const data = await fs2.readFile(filePath, "utf8");
      const stats = JSON.parse(data);
      if (!stats.stats.totalInventoryValue) {
        stats.stats.totalInventoryValue = 0;
      }
      if (typeof stats.stats.todayRefunds === "undefined") {
        stats.stats.todayRefunds = 0;
      }
      if (typeof stats.stats.netSales === "undefined") {
        stats.stats.netSales = stats.stats.todaySales || 0;
      }
      const updatedStats = {
        ...stats.stats,
        ...updates
      ...
      const { totalInventoryValue, ...persistentFields } = updatedStats;
      await fs2.writeFile(filePath, JSON.stringify({ stats: persistentFields }, null, 2), "utf8");
      return updatedStats;
    } catch (error) {
  ...
  try {
    ...
    if (userInfoHeader && typeof userInfoHeader === "string") {
      try {
        ...
        if (userData && typeof userData === "object" && "id" in userData && "username" in userData && "userRole" in userData) {
          if (!["Administrator", "Manager", "Cashier", "Stocker", "system"].includes(userData.userRole)) {
            console.warn(`Invalid userRole detected: ${userData.userRole}, defaulting to Cashier`);
    ...
    return { id: 0, username: "system", userRole: "system" };
  } catch (error) {
...
var isAdmin = (req, res, next) => {
  ...
  if (currentUser.userRole !== "Administrator") {
    console.warn(`Unauthorized admin access attempt by ${currentUser.username} (ID: ${currentUser.id}, Role: ${currentUser.userRole})`);
...
async function registerRoutes(app2) {
  ...
  app2.put("/api/inventory/:id", async (req, res) => {
    try {
      ...
      if (hasProfitUpdates && !["Administrator", "Manager"].includes(currentUser.userRole)) {
        await ActivityLogger.logInventoryActivity(
          currentUser.id,
          currentUser.username,
      ...
      if (hasPriceUpdate && currentUser.userRole === "Stocker") {
        await ActivityLogger.logInventoryActivity(
          currentUser.id,
          currentUser.username,
          LOG_ACTIONS.INVENTORY.UPDATE,
  ...
  app2.delete("/api/inventory/:id", async (req, res) => {
    try {
      const id = parseInt(req.params.id);
      const currentUser = getCurrentUser(req);
      if (currentUser.userRole === "Stocker") {
        await ActivityLogger.logInventoryActivity(
          currentUser.id,
          currentUser.username,
  ...
  app2.put("/api/users/:id", async (req, res) => {
    try {
      ...
      if (updates.userRole !== void 0 && user.userRole !== updates.userRole) {
        details += `, Role changed from ${user.userRole} to ${updates.userRole}`;
      }
  ...
  app2.delete("/api/users/:id", async (req, res) => {
    try {
      ...
      if (success) {
        ...
        const details = `Deleted user: ${user.username} (ID: ${user.id}, Role: ${user.userRole})`;
        await ActivityLogger.logUserActivity(
          currentUser.id,
          currentUser.username,
...
// server/./../node_modules/.bin/./../node_modules/.bin/vite.ts
...
// server/vite.ts
import { ./../node_modules/.bin/nanoid } from "nanoid";
...
app.use(helmet({
  ...
  // We're keeping the X-Powered-By header for development purposes
  // In a production environment, this should be set to true for security
  hidePoweredBy: false
}));
...
// Fallback: return index.html for React Router routes
