...
import AddInventoryItemForm from "./src/components/AddInventoryItemForm";
import EditInventoryItemForm from "./src/components/EditInventoryItemForm";
import BulkInventoryImport from "./src/components/BulkInventoryImport";
...
const Inventory: React.FC = () => {
  ...
  const [user.role, setUserRole] = useState<string>("Administrator"); // Default to Administrator
  const { toast } = useToast();
  
  // Get user user.role from session storage
  useEffect(() => {
    ...
    // Check for user.role changes every 3 seconds
