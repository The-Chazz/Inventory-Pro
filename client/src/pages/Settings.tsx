...
import StoreLogoUploader from "./src/components/StoreLogoUploader";
...
import { Loader2 } from "./../../node_modules/lucide-react/dist/cjs/lucide-react";
...
const storeSettingsSchema = z.object({
  ...
  nextTransactionId: z.number().min(1, "Transaction ID must be at least 1")
});
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Next Transaction ID</FormLabel>
                          <FormControl>
                            <Input 
                              type="number" 
                              min="1"
                          ...
                          <p className="text-sm text-muted-foreground mt-1">
                            This is the next transaction ID that will be used for new sales.
                          </p>
                        </FormItem>
                      )}
                    />
